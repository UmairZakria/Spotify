...
<body>
    <div class="box">
        <div class="subbox">
            ...
            <form action="process2.php" onsubmit=" return chkme()" method="post">
                <p>Email :</p>
                ...
                <div class="" style=" color: rgb(243, 114, 127);display: none;align-items: flex-start;justify-content: flex-start; flex-direction:row; " id="error">
                    ...
                    <span style="margin-left: 10px;">Enter Email    </span>
            ...
            <p style="color:rgb(184, 178, 169);font-size:15px">Don't have an account? <a href="sign_up.php">Sign up for Spotify</a></p>
        </div>
    </div>
</body>
