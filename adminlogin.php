...
<body>
    <div class="box">
        <div class="subbox">
            ...
            <script>
                function chkme() {
                    ...
                    if (useremail === "" && userpassword === ""){
                        ...
                        document.getElementById('useremail').style.border = "1px solid rgb(243, 114, 127)";
                        document.getElementById('userpassword').style.border = "1px solid rgb(243, 114, 127)";
                        return false
                    }else if (useremail === "" ){
                        document.getElementById('error').style.display = "flex";
                        document.getElementById('useremail').style.border = "1px solid rgb(243, 114, 127)";
            ...
            <form action="admin.php" onsubmit=" return chkme()" method="get">
                <p>User-Name :</p>
                <input type="text" name="adminname" id="useremail">
                <div class="" style=" color: rgb(243, 114, 127);display: none;align-items: flex-start;justify-content: flex-start; flex-direction:row; " id="error">
                    ...
                    <span style="margin-left: 10px;">Enter User-Name   </span>

                </div>
                <p>Password :</p>
                <input type="password" name="adminpass" id="userpassword" >
                ...
                <input type="submit" class="nxtbtn" value="Log in">
            </form>
